  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        // form.setValue("service_id", userData.service_id);
        form.setValue("phone_number", userData.phone_number);
        
        // Set the region and city
        setRegionName(userData.region);
        setCityName(userData.city || "hi");
        setProfession(userData.service)
        ...
        <div className=" md:w-2/3  w-full h-full  flex items-center flex-col  gap-4 mx-auto ">
          <Dialog>
            <DialogTrigger asChild>
              <Button
                variant="outline"
                className="w-full flex justify-between md:px-20 mx-auto group"
              >
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              ...
                              >
                                ...
                                <FormDescription>your service : {profession}</FormDescription>
                              </Select>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Select
                                value={cityName || field.value}
                                onValueChange={handleCityChange}
                                defaultValue={cityName || "Select a city"}
                              >
                                <SelectTrigger>
                                ...
                                <FormDescription>If you want to edit the city please choose the state </FormDescription>
                              </Select>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
